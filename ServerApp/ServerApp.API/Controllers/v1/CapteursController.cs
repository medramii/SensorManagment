...
namespace ServerApp.API.Controllers.v1;

/// <summary>
/// This version of api interacts with an SQL Server Database
/// </summary>
[ApiController()]
[ApiVersion("1.0")]
...
{
    private readonly ICapteurRepository<SqlServerDbContext> _capteurRepo;
    private readonly ILoggerManager _logger;

    /// <summary>
    /// This version of api interacts with an SQL Server Database
    /// </summary>
    public CapteursController(ICapteurRepository<SqlServerDbContext> capteurRepo, ILoggerManager logger)
    {
